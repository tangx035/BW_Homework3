...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'BW_HW3.data';
    var REMOTE_PACKAGE_BASE = 'BW_HW3.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2723329;
      var PACKAGE_UUID = '35ad08f6-1a29-4403-9bc5-9255b5059e47';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 378315, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(378315, 378334, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(378334, 378496, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(378496, 1820732, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1820732, 2695704, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2695704, 2723329, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_BW_HW3.data');

    };
    Module['addRunDependency']('datafile_BW_HW3.data');
